...
public enum ErrorType {
    ...
    AUTHORIZATION_ERROR(4300, "you have no permission to make an action", HttpStatus.BAD_REQUEST),
    USER_NOT_FOUND(4400, "Böyle bir kullanıcı bulunamadı", HttpStatus.NOT_FOUND),
    COMMENT_NOT_FOUND(4400, "recipe not found", HttpStatus.NOT_FOUND),
    ...
    POINT_ALREADY_EXIST(4450, "you can not point a recipe twice", HttpStatus.BAD_REQUEST),
